...
class DensePassageRetriever(BertPretrainedModel):
    def __init__(self, args, shared_doc_embed, weight):
        ...
        self.label_classifier = BertLMHead(hidden_size=self.vector_dim, vocab_size=self.num_class)
    ...
    def update_embeddings(self):
        ...
        bs = BatchSampler(sampler=sampler, batch_size=1000)
        ...
        for step, batch in enumerate(dataloader):
            with paddle.no_grad():
                ...
                self._doc_embed[idx,:] = passage_embed.cpu()
